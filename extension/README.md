...
- or build it with `npm i && npm run build` (in `./extension`) and [load the extension's folder](https://developer.chrome.com/docs/extensions/get-started/tutorial/hello-world#load-unpacked) `./extension/chrome/dist`;
